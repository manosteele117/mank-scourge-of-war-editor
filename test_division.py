...
ROW_INDEX = 59
FORMATION = 'DRIL_Lvl4_Inf_Reserves'
...
print(f'Row dist: {oob.build_strength(ROW_INDEX, archetype_id=FORMATION).archetype.row_dist}')
...
print()
print('Overlap check (seq 3 vs seq 12):')
if '3' in pos and '12' in pos:
    x3, y3, l3, d3 = pos['3']
    x12, y12, l12, d12 = pos['12']
    front3 = y3 - d3 / 2
    back3 = y3 + d3 / 2
    front12 = y12 - d12 / 2
    back12 = y12 + d12 / 2
    print(f'  seq  3: y={y3:8.1f}  front={front3:8.1f}  back={back3:8.1f}  depth={d3:.1f}')
    print(f'  seq 12: y={y12:8.1f}  front={front12:8.1f}  back={back12:8.1f}  depth={d12:.1f}')
    gap = front12 - back3
    print(f'  gap (front12 - back3): {gap:.1f}')
    if gap >= 0:
        print('  PASS: seq 12 is fully behind seq 3')
    else:
        print(f'  FAIL: seq 12 overlaps seq 3 by {-gap:.1f}')
else:
    print('  seq 3 or seq 12 not in layout')
